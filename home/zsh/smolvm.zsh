...
# zsh completion for the Smol Machines smolvm CLI (v1.7.2).
...
_smolvm_machine_fork() {
  _arguments \
    ...
    '(-n --name)'{-n,--name}'[Name for the new clone machine]:name:' \
    ...
    '*'{-e,--env}'[Per-fork parameter, delivered as /run/smolvm/fork-env (repeatable)]:KEY=VALUE:' \
