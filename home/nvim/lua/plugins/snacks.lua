return {
  ...
  keys = function()
    ...
    return {
      ...
      { "<leader>gB", function() Snacks.gitbrowse() end, desc = "Git Browse Repo", mode = { "n", "v" } },
      { "<leader>gY",
        function()
          Snacks.gitbrowse {
      ...
      -- Additional keys
      { "<leader>gH", desc = "Lazygit History: Current File", function() Snacks.lazygit.log_file() end },
